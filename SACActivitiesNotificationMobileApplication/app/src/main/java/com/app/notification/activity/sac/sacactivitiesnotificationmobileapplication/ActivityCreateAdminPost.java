...
public class ActivityCreateAdminPost extends AppCompatActivity {
    ...
    private void publishPost(final String title ,final String content){
            ...
            mDataBase.child("adminPost").updateChildren(childUpdates).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(ActivityCreateAdminPost.this,"Error Posting", Toast.LENGTH_SHORT).show();
                }
            });
        }
